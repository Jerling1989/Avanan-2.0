(function() {
    'use strict';
    var t = {
        ctaModules: document.querySelectorAll('.cta-module[data-space-bottom*="neg"]'),
        scrollbarWidth: window.innerWidth - document.documentElement.clientWidth,
        init: function() {
            if (this.ctaModules[0]) {
                document.body.style.overflowX = 'hidden';
                if (this.scrollbarWidth) {
                    for (var t = 0; t < this.ctaModules.length; t++) {
                        var i = this.ctaModules[t],
                            e = i.getElementsByClassName('cta-module--image')[0];
                        if (e) {
                            this.adjustWidth(e);
                            window.addEventListener('resize', this.adjustWidth(e))
                        }
                    }
                }
            }
        ...
        adjustWidth: function(e) {
            e.style.width = 'calc(100vw - ' + t.scrollbarWidth + 'px)'
        }
    };
    t.init()
})();;
...
(function() {
    ...
    var l = document.getElementsByClassName('anim');
    for (var e = 0; e < l.length; e++) {
        new ScrollMagic.Scene({
            ...
            reverse: !1,
            loglevel: 3
        }).setClassToggle(l[e], 'animated').addTo(window.AnimationController)
    }
})();;
(function() {
    CustomEase.create('simpleEase', 'M0,0 C0.25,0.1 0.25,1 1,1');
    var a = 'screen and (max-width: 63.9375em)',
    ...
    e.addListener(n.handleEvent);
    var t = {
        partnersEl: document.getElementsByClassName('animation-home-partners')[0],
        init: function() {
            if (!this.partnersEl.classList.contains('js-animate')) {
                return
            };
            var e = this.partnersEl.getElementsByClassName('cta-module--anim--image__group-1'),
                t = this.partnersEl.getElementsByClassName('cta-module--anim--image__group-2');
            e = [].slice.call(e);
            t = [].slice.call(t);
            this.arrange(e);
            this.arrange(t);
        ...
        arrange: function(e) {
            for (var a = 0; a < e.length; a++) {
                var t = e[a];
                t.style.left = t.dataset.animHpos + 'px';
                t.style.top = t.dataset.animVpos + 'px'
            };
            e.sort(function(e, t) {
                return e.dataset.animHpos - t.dataset.animHpos
            })
        },
        nestedAlpha: function(e) {
            this.nested = new TimelineLite();
            this.nested.to(e, 0.5, {
                autoAlpha: 1,
            })
        },
        animate: function(a, s) {
            this.headerGroup = this.partnersEl.getElementsByClassName('cta-module--submodule__element')[0].children;
            var i = new TimelineLite(),
                n = new TimelineLite(),
                d = new TimelineLite(),
                p = new TimelineLite(),
                r = new TimelineLite();
            r.set(this.headerGroup, {
                y: 40,
                autoAlpha: 0,
            }).staggerTo(this.headerGroup, 1, {
                y: 0,
                autoAlpha: 1,
                ease: 'simpleEase',
            }, 0.166);
            d.set(a, {
                ...
                skewY: -16,
                scaleY: 1.1,
                boxShadow: '2px 2px 1px 0px rgba(0, 0, 0, 0.15)',
            }).staggerTo(a, 0.833, {
                y: 0,
                ease: 'simpleEase',
                onStart: function() {
                    t.nestedAlpha(this.target)
                },
            }, 0.048);
            p.set(s, {
                y: 40,
                ...
                y: 0,
                ease: 'simpleEase',
                boxShadow: '15px 20px 24px rgba(0, 0, 0, .15)',
                onStart: function() {
                    t.nestedAlpha(this.target)
                },
            }, 0.123);
            var m = new ScrollMagic.Scene({
                triggerHook: 0.5,
                triggerElement: this.partnersEl,
                reverse: !1,
                loglevel: 3,
            });
            var l = new ScrollMagic.Scene({
                triggerHook: 0.5,
                triggerElement: this.partnersEl.querySelector('.cta-module--media'),
                reverse: !1,
                loglevel: 3,
            });
            ...
            function g(e) {
                if (e.matches) {
                    o.removeTween(i).remove(!0);
                    l.setTween(n).addTo(window.AnimationController);
                    m.setTween(r).addTo(window.AnimationController)
                } else {
                    l.removeTween(n).remove(!0);
                    m.removeTween(r).remove(!0);
                    i.add([r, n], '0', 'start');
                    o.setTween(i).addTo(window.AnimationController)
                }
            };
            g(e);
            e.addListener(g)
...
! function(t, e) {
    ...
    var h = function() {
        ...
        p = function() {
            function n(t) {
                ...
                r(this, n), this._c = {}, this._t = [], this._e = new h, this.disabled = !1, this.selector = t, this.settings = d(i, e), this.index = this.settings.startAt
            }
            return o(n, [{
                key: "mount",
                value: function() {
    ...
    var O = ["touchstart", "mousedown"],
        ...
        C = ["touchend", "touchcancel", "mouseup", "mouseleave"],
    ...
    var L = {
        ...
        Clones: function(d, h, t) {
            var e = {
                ...
                collect: function() {
                    for (var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [], e = h.Html.slides, n = d.settings, i = n.perView, r = n.classes, o = e.slice(0, i), s = e.slice(-i), u = 0; u < Math.max(1, Math.floor(i / e.length)); u++) {
                ...
                append: function() {
                    for (var t = this.items, e = h.Html, n = e.wrapper, i = e.slides, r = Math.floor(t.length / 2), o = t.slice(0, r).reverse(), s = t.slice(r, t.length), u = 0; u < s.length; u++) n.appendChild(s[u]);
        ...
        Build: function(n, i, t) {
            var e = {
                ...
                activeClass: function() {
                    ...
                    t && (t.classList.add(e.activeSlide), w(t).forEach(function(t) {
        ...
        Run: function(o, n, s) {
            var t = {
                ...
                calculate: function() {
                    ...
                    switch (i) {
                        case ">":
                            ">" === n ? o.index = e : this.isEnd() ? (o.isType("slider") && !o.settings.rewind || (this._o = !0, o.index = 0), s.emit("run.end", t)) : r ? o.index += Math.min(e - o.index, -y(n)) : o.index++;
                            break;
                        case "<":
                            "<" === n ? o.index = 0 : this.isStart() ? (o.isType("slider") && !o.settings.rewind || (this._o = !0, o.index = e), s.emit("run.start", t)) : r ? o.index -= Math.min(o.index, y(n)) : o.index--;
                            break;
                        case "=":
                            o.index = n
                    }
            ...
            var n = new S,
                ...
                t = {
                    ...
                    bindSwipeStart: function() {
                        var e = this,
                            t = d.settings;
                        t.swipeThreshold && n.on(O[0], h.Html.wrapper, function(t) {
                            e.start(t)
                        }, {
                            passive: !0
                        }), t.dragThreshold && n.on(O[1], h.Html.wrapper, function(t) {
                            e.start(t)
                        })
                    },
                    unbindSwipeStart: function() {
                        n.off(O[0], h.Html.wrapper), n.off(O[1], h.Html.wrapper)
                    },
                    bindSwipeMove: function() {
                        var e = this;
                        n.on(A, h.Html.wrapper, b(function(t) {
                            e.move(t)
                        }, d.settings.throttle), {
                            passive: !0
                        })
                    ...
                    bindSwipeEnd: function() {
                        var e = this;
                        n.on(C, h.Html.wrapper, function(t) {
                            e.end(t)
                        })
                    },
                    ...
                    touches: function(t) {
                        return -1 < M.indexOf(t.type) ? t : t.touches[0] || t.changedTouches[0]
                    },
                    threshold: function(t) {
                        var e = d.settings;
                        return -1 < M.indexOf(t.type) ? e.dragThreshold : e.swipeThreshold
                    },
                    enable: function() {
...
(function() {
    'use strict';
    var e = {
        allShows: document.getElementsByClassName('glide'),
        options: {
            type: 'carousel',
            startAt: 0,
            gap: 0,
        ...
        init: function() {
            for (var e = 0; e < this.allShows.length; e++) {
                this.createShow(this.allShows[e])
            }
        },
        createShow: function(e) {
            var r = {
                autoplay: e.dataset.timing
            };
            var a = [r, this.options];
            this.options = a.reduce(function(e, t) {
                Object.keys(e).forEach(function(n) {
                    t[n] = e[n]
                });
                return t
            }, {});
            var o = new Glide(e, this.options),
            ...
            new ScrollMagic.Scene({
                ...
                reverse: !1,
                loglevel: 3,
            }).addTo(i).on('enter leave', function(e) {
                o.mount()
            });
            var n = e.getElementsByClassName('glide__controls');
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine.plugin({
            ...
            API: 2,
            version: '0.6.1',
            init: function(t, n, u, i) {
                var e, o;
                if ('function' != typeof t.setAttribute) return !1;
                for (e in n) o = n[e], 'function' == typeof o && (o = o(i, t)), this._addTween(t, 'setAttribute', t.getAttribute(e) + '', o + '', e, !1, e), this._overwriteProps.push(e);
                return !0
            }
        })
    }), _gsScope._gsDefine && _gsScope._gsQueue.pop()(),
...
(function() {
    ...
    const query = window.matchMedia(mobileTabletOnly);
    const listener = {
        handleEvent: function() {
            return query.matches
        },
    };
    query.addListener(listener.handleEvent);
    CustomEase.create('simpleEase', 'M0,0 C0.25,0.1 0.25,1 1,1');
    var e = {
        init: function(e) {
            this.element = document.getElementsByClassName(e);
            for (var t = 0; t < this.element.length; t++) {
                this.addTween(this.element[t])
            }
        },
        addTween: function(e) {
            var d = new TimelineLite(),
                a = new TimelineLite(),
                o = new TimelineLite();
            if (e.classList.contains('left-right-homepage-digital-business-animation')) {
                var i = 'http://www.w3.org/2000/svg',
                    x = e.querySelector('#digital-business defs');
                for (var n = 0; n < 1; n++) {
                    var f = 'shadowDigitalB' + n,
                        v = 'feoffset' + n,
                        t = document.createElementNS(i, 'filter');
                    t.setAttribute('id', f);
                    t.setAttribute('color-interpolation-filters', 'linearRGB');
                    t.setAttribute('primitiveUnits', 'userSpaceOnUse');
                    t.setAttribute('filterUnits', 'objectBoundingBox');
                    t.setAttribute('height', '160%');
                    t.setAttribute('width', '150%');
                    t.setAttribute('y', '-20%');
                    t.setAttribute('x', '-20%');
                    var s = document.createElementNS(i, 'feOffset');
                    s.setAttribute('id', v);
                    s.setAttribute('dx', '14');
                    s.setAttribute('dy', '14');
                    s.setAttribute('in', 'SourceAlpha');
                    s.setAttribute('result', 'offset');
                    var c = document.createElementNS(i, 'feGaussianBlur');
                    c.setAttribute('stdDeviation', '10');
                    c.setAttribute('in', 'offset');
                    c.setAttribute('result', 'blur');
                    var u = document.createElementNS(i, 'feFlood');
                    u.setAttribute('flood-color', '#000000');
                    u.setAttribute('flood-opacity', '0.22');
                    u.setAttribute('result', 'flood');
                    var r = document.createElementNS(i, 'feComposite');
                    r.setAttribute('in', 'flood');
                    r.setAttribute('in2', 'blur');
                    r.setAttribute('operator', 'in');
                    r.setAttribute('result', 'composite');
                    var l = document.createElementNS(i, 'feMerge');
                    l.setAttribute('result', 'merge');
                    var b = document.createElementNS(i, 'feMergeNode');
                    b.setAttribute('in', 'composite');
                    b.setAttribute('result', 'mergeNode');
                    var h = document.createElementNS(i, 'feMergeNode');
                    h.setAttribute('in', 'SourceGraphic');
                    h.setAttribute('result', 'mergeNode1');
                    t.appendChild(s);
                    t.appendChild(c);
                    t.appendChild(u);
                    t.appendChild(r);
                ...
                this.copy1 = e.getElementsByClassName('left-right--content__heading')[0];
                this.copy2 = e.getElementsByClassName('left-right--content__copy')[0];
                this.button1 = e.getElementsByClassName('button-primary')[0];
                this.button2 = e.getElementsByClassName('button-link')[0];
                this.info_block = e.querySelector('#info-box');
                this.submit = e.querySelector('#submit');
                this.submit_box = e.querySelector('#submit-box');
                this.submit_person = e.querySelector('#submit-person');
                this.signature_box = e.querySelector('#signature-box');
                this.approved_person = e.querySelector('#approved-person');
                this.approved_group = e.querySelector('#approved');
                this.box_1 = e.querySelector('#box-1');
                this.box_2 = e.querySelector('#box-2');
                this.box_3 = e.querySelector('#box-3');
                this.box_4 = e.querySelector('#box-4');
                this.box_5 = e.querySelector('#box-5');
                this.signature_group = e.querySelector('#signature-box-group');
                this.docusign = e.querySelector('#docusign');
                this.signature = e.querySelector('#signature-2');
                this.info_block.setAttribute('filter', 'url(#shadowDigitalB0)');
                this.submit_box.setAttribute('filter', 'url(#shadowDigitalB0)');
                this.submit_person.setAttribute('filter', 'url(#shadowDigitalB0)');
                this.signature_box.setAttribute('filter', 'url(#shadowDigitalB0)');
                this.approved_person.setAttribute('filter', 'url(#shadowDigitalB0)');
                this.box_5.setAttribute('filter', 'url(#shadowDigitalB0)');
                a.set([this.copy1, this.copy2, this.button1, this.button2], {
                    opacity: 0,
                }).set(this.copy1, {
                    y: 20,
                }).set(this.copy2, {
                    ...
                    ease: 'simpleEase',
                    opacity: 1,
                }, 4).to(this.button1, 12, {
                    y: 0,
                    ease: 'simpleEase',
                    opacity: 1,
                }, 8).to(this.button2, 12, {
                    y: 0,
                    ease: 'simpleEase',
                    opacity: 1,
                }, 12);
                o.set(this.submit, {
                    scale: .75,
                    opacity: 0
                }).set(this.submit_person, {
                    x: 100
                }).set(this.info_block, {
                    x: -108,
                    opacity: 0,
                    scale: .75,
                }).set(this.signature_group, {
                    x: -108,
                    opacity: 0,
                    scale: .75,
                }).set(this.docusign, {
                    ...
                    strokeWidth: 3,
                    strokeMiterlimit: 4,
                }).set(this.approved_person, {
                    x: 160,
                    autoAlpha: 0,
                    scale: .75,
                }).set(this.approved_group, {
                    x: -108,
                    scale: .75,
                    y: 36
                }).set([this.box_1, this.box_2, this.box_3, this.box_4, this.box_5], {
                    opacity: 0,
                }).set(this.box_1, {
                    x: 0,
                }).set(this.box_2, {
                    ...
                    scale: 1,
                    opacity: 1,
                }, 0).to(this.submit_person, 17, {
                    x: 0,
                    ease: Back.easeOut.config(1)
                }, 3).to(this.info_block, 26, {
                    x: 0,
                    scale: 1,
                    opacity: 1,
                }, 7).to(this.signature_group, 20, {
                    x: 0,
                    scale: 1,
                    opacity: 1,
                }, 3).to(this.docusign, 20, {
                    y: 0,
                }, 7).to(this.signature, 35, {
                    drawSVG: '100%',
                    ease: Sine.easeIn
                }, 27).to(this.approved_group, 19, {
                    x: 0,
                    scale: 1,
                    y: 0
                }, 47).staggerTo([this.box_1, this.box_2, this.box_3, this.box_4], 19, {
                    opacity: 1,
                }, 3, 47).staggerTo([this.box_1, this.box_2, this.box_3, this.box_4], 12, {
                    x: 0,
                }, 3, 59).to(this.box_5, 3, {
                    opacity: 1,
                }, 79).to(this.approved_person, 17, {
                    autoAlpha: 1,
                    x: 0,
                    scale: 1,
                    ease: Back.easeOut.config(1),
                ...
                var g = new ScrollMagic.Scene({
                    triggerHook: 0.5,
                    triggerElement: e.querySelector('.left-right--media'),
                    reverse: !1,
                    loglevel: 3,
                });
                var m = new ScrollMagic.Scene({
                ...
                var y = new ScrollMagic.Scene({
                    triggerHook: 0.5,
                    triggerElement: e.querySelector('.left-right--content'),
                    reverse: !1,
                    loglevel: 3,
                });
                ...
                function p(e) {
                    if (e.matches) {
                        m.removeTween(d).remove(!0);
                        g.setTween(o).addTo(window.AnimationController);
                        y.setTween(a).addTo(window.AnimationController)
                    } else {
                        d.add(a, 0).add(o, .3);
                        g.removeTween(o).remove(!0);
                        y.removeTween(a).remove(!0);
                        m.setTween(d).addTo(window.AnimationController)
                    }
                };
                p(query);
                query.addListener(p)
...
(function(t, e) {
    ...
    const mobileTabletOnly = 'screen and (max-width: 63.9375em)';
    const query = matchMedia(mobileTabletOnly);
    const listener = {
        handleEvent: function() {
            return query.matches
        },
    ...
    query.addListener(listener.handleEvent);
    const calculateHeight = function(t, e, o, n) {
        let newHeight = 0;
        if (e > 0) {
            newHeight -= (e / n)
        } else {
            newHeight += Math.abs(e)
        };
        if (t > 0) {
            newHeight -= (t / n)
        } else {
            newHeight += Math.abs(t / n)
        };
        newHeight += o;
        return newHeight + 'px'
    };
    const calculateYPosition = function(t, e) {
        let newYPos = 0;
        if (t > 0) {
            newYPos += (t / e)
        } else {
            newYPos -= Math.abs(t / e)
        };
        return newYPos
    };
    const calculateYPositionMobile = function(t, e) {
        let newYPos = 0;
        if (t > 0) {
            newYPos -= (t / e)
        } else {
    ...
    const checkSizingChart = function(t) {
        const spaceTop = t.dataset.spaceTop;
        const spaceBottom = t.dataset.spaceBottom;
        const isMobile = listener.handleEvent();
        let datasetSpaceBottom = null;
        const datasetSpaceTop = sizingChart.desktop[spaceTop] || 0;
        if (!isMobile) {
            datasetSpaceBottom = sizingChart.desktop[spaceBottom] || 0
        } else {
            datasetSpaceBottom = sizingChart.tablet[spaceBottom] || 0
        };
        return {
            datasetSpaceTop: datasetSpaceTop,
            datasetSpaceBottom: datasetSpaceBottom
        }
    };
    const processSizes = function(e, t, n) {
        const moduleElementHeight = e.getBoundingClientRect().height;
        const datasetSpaceTop = n.datasetSpaceTop;
        const datasetSpaceBottom = n.datasetSpaceBottom;
        const isMobile = listener.handleEvent();
        const scaleFactor = 1;
        if (!isMobile) {
            ...
            t.style.transform = '';
            t.style.marginTop = '';
            t.style.height = calculateHeight(datasetSpaceBottom, datasetSpaceTop, moduleElementHeight, scaleFactor);
            if (calculateYPosition(datasetSpaceTop, scaleFactor) !== 0) {
                t.style.transform = 'translateY(' + calculateYPosition(datasetSpaceTop, scaleFactor) + 'px)'
            };
            if (datasetSpaceBottom === 0) {
                t.style.bottom = 0;
                t.style.top = 'auto';
                t.style.transform = ''
            }
            ...
            t.style.height = '';
            t.style.transform = '';
            if (calculateYPositionMobile(datasetSpaceBottom, scaleFactor) > 0) {
                t.style.transform = 'translateY(' + calculateYPositionMobile(datasetSpaceBottom, scaleFactor) + 'px)';
                t.style.marginTop = -(calculateYPositionMobile(datasetSpaceBottom, scaleFactor)) + 'px'
            } else {
                t.style.paddingBottom = Math.abs(calculateYPositionMobile(datasetSpaceBottom, scaleFactor)) + 'px'
            }
        }
    };
    const processModule = function(n) {
        const mediaElement = n.getElementsByClassName('left-right--media')[0];
        const contentElement = n.getElementsByClassName('left-right--content')[0];
        const pictureElement = mediaElement.getElementsByTagName('picture')[0] || mediaElement.getElementsByClassName('svg-container')[0];
        const container = n.getElementsByClassName('container')[0];
        if (!container) {
            console.warn('No container class present.');
            return
        };
        const gap = e.createElement('div');
        gap.classList.add('left-right--gap');
        container.appendChild(gap);
        if (!mediaElement) {
            console.warn('No media element is present.');
            return
        };
        if (!pictureElement) {
            console.warn('No picture element is present.');
            return
        };
        const image = n.getElementsByTagName('img')[0] || n.getElementsByTagName('svg')[0];
        if (!image) {
        ...
        function o() {
            processSizes(n, mediaElement, checkSizingChart(mediaElement));
            processMediaOffsetX(n, contentElement, pictureElement, gap, mediaElement)
        };
        ...
        image.addEventListener('load', function(e) {
            e.target.parentNode.style.visibility = '';
            o();
            t.addEventListener('resize', function() {
                o()
            }, !1)
    ...
    const getPosition = function(t) {
        const elObj = t.getBoundingClientRect();
        return {
            left: elObj.left,
            width: elObj.width,
            right: elObj.right,
    ...
    const processMediaOffsetX = function(t, e, n, o, s) {
        if (!listener.handleEvent()) {
            const containerPositionProp = getPosition(t.getElementsByClassName('container')[0]);
            const containerWidth = containerPositionProp.width;
            const moduleWidth = getPosition(t).width;
            const marginWidth = (moduleWidth - containerWidth) / 2;
            const contentElementProp = getPosition(e);
            const contentWidth = contentElementProp.width;
            const mediaElementWidth = getPosition(s).width - marginWidth;
            const flipped = t.classList.contains('flipped') || !1;
            const gapWidth = getPosition(o).width;
            let contentOffset = 0;
            const contentElementOffsetLeft = (contentElementProp.left - containerPositionProp.left);
            const contentElementOffsetRight = (contentElementProp.right - containerPositionProp.right);
            if (flipped) {
                contentOffset = Math.abs(contentElementOffsetRight)
            } else {
                contentOffset = contentElementOffsetLeft
            };
            const widthDifference = (mediaElementWidth + contentWidth + contentOffset) + gapWidth;
            let offsetX = Math.round(containerWidth - widthDifference);
            let pictureXPos = 0;
            if (widthDifference > containerWidth) {
                offsetX = Math.abs(offsetX);
                pictureXPos = flipped ? -offsetX : offsetX
            };
            n.style.transform = pictureXPos ? 'translateX(' + pictureXPos + 'px)' : null
        } else {
            n.style.transform = null
        }
    };
    const moduleElements = [].slice.call(e.getElementsByClassName('left-right'));
    if (!moduleElements) {
        return
    };
    moduleElements.forEach(function(t) {
        processModule(t)
    })
})(window, document);;
(function() {
    ...
    var e = {
        ...
        chooseResponsiveAsset: function(t) {
            if (t.matches) {
                e.mobileAsset.style.display = 'block';
                e.desktopAsset.style.display = 'none'
            } else {
                e.mobileAsset.style.display = 'none';
                e.desktopAsset.style.display = 'block'
            }
        },
        addTween: function(e) {
            if (e.classList.contains('left-right-homepage-security-animation')) {
                this.mobileAsset = e.querySelector('#security-mobile-animation');
                this.desktopAsset = e.querySelector('#security-animation');
                this.chooseResponsiveAsset(query);
                query.addListener(this.chooseResponsiveAsset);
                var y = new TimelineLite(),
                    m = new TimelineLite(),
                    b = new TimelineLite(),
                    d = new TimelineLite(),
                    i = 'http://www.w3.org/2000/svg',
                    E = this.desktopAsset.querySelector('defs'),
                    v = this.mobileAsset.querySelector('defs');
                for (var r = 1; r < 6; r++) {
                    var p = 'mobileShadow' + r,
                        f = 'mobileFeoffset' + r,
                        t = document.createElementNS(i, 'filter');
                    t.setAttribute('id', p);
                    t.setAttribute('color-interpolation-filters', 'linearRGB');
                    t.setAttribute('primitiveUnits', 'userSpaceOnUse');
                    t.setAttribute('filterUnits', 'objectBoundingBox');
                    t.setAttribute('height', '170%');
                    t.setAttribute('width', '170%');
                    t.setAttribute('y', '-20%');
                    t.setAttribute('x', '-20%');
                    var s = document.createElementNS(i, 'feOffset');
                    s.setAttribute('id', f);
                    ...
                    s.setAttribute('in', 'SourceAlpha');
                    s.setAttribute('result', 'offset');
                    var n = document.createElementNS(i, 'feGaussianBlur');
                    n.setAttribute('stdDeviation', '17');
                    n.setAttribute('in', 'offset');
                    n.setAttribute('result', 'blur');
                    var a = document.createElementNS(i, 'feFlood');
                    a.setAttribute('flood-color', '#000000');
                    a.setAttribute('flood-opacity', '0.15');
                    a.setAttribute('result', 'flood');
                    var o = document.createElementNS(i, 'feComposite');
                    o.setAttribute('in', 'flood');
                    o.setAttribute('in2', 'blur');
                    o.setAttribute('operator', 'in');
                    o.setAttribute('result', 'composite');
                    var l = document.createElementNS(i, 'feMerge');
                    l.setAttribute('result', 'merge');
                    var h = document.createElementNS(i, 'feMergeNode');
                    h.setAttribute('in', 'composite');
                    h.setAttribute('result', 'mergeNode');
                    var u = document.createElementNS(i, 'feMergeNode');
                    u.setAttribute('in', 'SourceGraphic');
                    u.setAttribute('result', 'mergeNode1');
                    t.appendChild(s);
                    t.appendChild(n);
                    t.appendChild(a);
                    t.appendChild(o);
                ...
                this.button1 = e.getElementsByClassName('button-primary')[0];
                this.button2 = e.getElementsByClassName('button-link')[0];
                this.mobileIcon1 = e.querySelector('#sm_pdf-anim-1');
                this.mobileIcon2 = e.querySelector('#sm_powerpoint-anim-2');
                this.mobileIcon3 = e.querySelector('#sm_word-anim-2');
                this.mobileIcon4 = e.querySelector('#sm_boxnotes-anim-4');
                this.mobileIcon5 = e.querySelector('#sm_folder-y-anim-5');
                this.mobileShadow1 = e.querySelector('#mobileFeoffset1');
                this.mobileShadow2 = e.querySelector('#mobileFeoffset2');
                this.mobileShadow3 = e.querySelector('#mobileFeoffset3');
                this.mobileShadow4 = e.querySelector('#mobileFeoffset4');
                this.mobileShadow5 = e.querySelector('#mobileFeoffset5');
                this.icon1 = e.querySelector('#pdf-anim-1');
                this.icon2 = e.querySelector('#jpg-anim-2');
                this.icon3 = e.querySelector('#powerpoint-anim-3');
                this.icon4 = e.querySelector('#word-anim-4');
                this.icon5 = e.querySelector('#boxnotes-anim-5');
                this.icon6 = e.querySelector('#word-anim-6');
                this.icon7 = e.querySelector('#folder-y-anim-7');
                this.shadow1 = e.querySelector('#feoffset1');
                this.shadow2 = e.querySelector('#feoffset2');
                this.shadow3 = e.querySelector('#feoffset3');
                this.shadow4 = e.querySelector('#feoffset4');
                this.shadow5 = e.querySelector('#feoffset5');
                this.shadow6 = e.querySelector('#feoffset6');
                this.shadow7 = e.querySelector('#feoffset7');
                this.mobileIcon1.setAttribute('filter', 'url(#mobileShadow1)');
                this.mobileIcon2.setAttribute('filter', 'url(#mobileShadow2)');
                this.mobileIcon3.setAttribute('filter', 'url(#mobileShadow3)');
                this.mobileIcon4.setAttribute('filter', 'url(#mobileShadow4)');
                this.mobileIcon5.setAttribute('filter', 'url(#mobileShadow5)');
                this.icon1.setAttribute('filter', 'url(#shadow1)');
                this.icon2.setAttribute('filter', 'url(#shadow2)');
                this.icon3.setAttribute('filter', 'url(#shadow3)');
                this.icon4.setAttribute('filter', 'url(#shadow4)');
                this.icon5.setAttribute('filter', 'url(#shadow5)');
                this.icon6.setAttribute('filter', 'url(#shadow6)');
                this.icon7.setAttribute('filter', 'url(#shadow7)');
                var c = -40;
                m.set([this.copy1, this.copy2, this.button1, this.button2], {
                    opacity: 0,
                }).set(this.copy1, {
                    y: 20,
                }).set(this.copy2, {
                ...
                d.set([this.mobileIcon1, this.mobileIcon2, this.mobileIcon3, this.mobileIcon4, this.mobileIcon5], {
                    opacity: 0,
                    attr: {
                        'y': 0
                    },
                }).staggerTo([this.mobileIcon1, this.mobileIcon2, this.mobileIcon3, this.mobileIcon4, this.mobileIcon5], 12, {
                    opacity: 1,
                    attr: {
                        'y': c
                    },
                }, 4, 8).staggerTo([this.mobileShadow1, this.mobileShadow2, this.mobileShadow3, this.mobileShadow4, this.mobileShadow5], 12, {
                    attr: {
                        'dy': 70
                    },
                    ease: 'simpleEase',
                }, 4, 8);
                b.set([this.icon1, this.icon2, this.icon3, this.icon4, this.icon5, this.icon6, this.icon7], {
                    opacity: 0,
                    attr: {
                        'y': 0
                    },
                ...
                function g(e) {
                    if (e.matches) {
                        S.removeTween(y).remove(!0);
                        w.setTween(d).addTo(window.AnimationController);
                        A.setTween(m).addTo(window.AnimationController)
                    } else {
                        y.add(m, 0).add(b, 0);
                        w.removeTween(d).remove(!0);
                        A.removeTween(m).remove(!0);
                        S.setTween(y).addTo(window.AnimationController)
                    }
                };
                g(query);
                query.addListener(g)
...
(function() {
    'use strict';
    var e = window.drupalSettings.boxPhones,
        i = window.drupalSettings.boxGlobal.countryCode;
    if (e !== undefined) {
        var n = document.getElementById('main-nav--telephone');
        if (!n) {
            return
        };
        var t = e['US'];
        ...
        n.setAttribute('data-telephone', t['tel']);
        n.setAttribute('data-printable-telephone', t['printable'])
    }
})();;